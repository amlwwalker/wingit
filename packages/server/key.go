...
func (srv *Server) GetKeys(idToken string) ([]utils.KeyServer, error) { // NOTE: FUNCTIONALITY WILL BE REMOVED
    ...
    contentBytes, err := srv.GetConnection("/keys/list", idToken)
    if err != nil {
...
func (srv *Server) GetKey(matchEmail, idToken string) ([]utils.KeyServer, error) {
    ...
    contentBytes, err := srv.GetConnection("/keys/retrieve", idToken + "&match=" + matchEmail)
    if err != nil {
